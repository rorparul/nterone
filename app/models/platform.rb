...
class Platform < ActiveRecord::Base
  ...
  def archive_associations
    has_many_associations.each do |has_many_association|
      has_many_association.update_all(archived: true)
    end
  end

  def unarchive_associations
    has_many_associations.each do |has_many_association|
      has_many_association.update_all(archived: false)
    end
  end
