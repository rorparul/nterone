...
sales         = User.create(email: 'sales@mail.com',         password: 'Password1')
sales_manager = User.create(email: 'sales_manager@mail.com', password: 'Password1')
brand_admin   = User.create(email: 'brand_admin@mail.com',   password: 'Password1')
super_admin   = User.create(email: 'super_admin@mail.com',   password: 'Password1')
...
when "development"
  ...
  platforms = Platform.create([{title: 'test platform 1'}, {title: 'test platform 2'}])
...
Role.create(user: User.last, role: 1)